...
= 2.6.6 =
* Added : Engine translations for Estonian, Finnish, Dutch, Polish and Portuguese
* Added : Franchise and deposit visibility controls in the front-end
* Fixed : My reservation - Allow documentation uploads when no signature is required
* Fixed : Apply Franchise and Deposit visibility settings consistently, including lazy-loaded products
* Fixed : Complete and synchronize translations for all supported locales

= 2.6.5 =
* Fixed : Only upload documentation without signature
...
* New : Selector use selectJS to search delivery/return places
* New : Allow to pay deposit

= 2.5.2 =
* Fixed Polylang links with query params
* Fixed Rent - Select product with multiple prices : Show the offer with % instead of with currency
* Fixed Rent - Custom delivery and collection address on rent selector
...
= 2.4.2 =
* Fixed: Show both offers and promotion code discount on select product and checkout
* Fixed: Calendar : Manage max days
* Fixed: Wizard : All destinations button was transparent. No text shown

= 2.4.1 =
* Fix plugin translations priority
...
= 2.6.6 =
* Added franchise/deposit visibility controls and five Engine languages; fixed document uploads without signature and completed translation coverage.
...
= 2.5.2 =
* Fixed polylang url with query string for my reservation and summary translation + selector
