...
?>
<h3>
  <?php echo esc_html_x( 'Customer', 'renting_my_reservation', 'mybooking-reservation-engine') ?>
</h3>
...
<% if (booking.customer_type == 'legal_entity') { %>
  ...
  <div class="mb-form-row">
    <div class="mb-form-group mb-col-md-6">
      ...
      <input class="mb-form-control" type="text" name="customer_email" autocomplete="off" placeholder="<?php echo esc_attr_x( 'E-mail', 'renting_complete', 'mybooking-reservation-engine') ?>" maxlength="50" value="<%=booking.customer_email%>" 
    ...
    <div class="mb-form-group mb-col-md-6">
      ...
      <input class="mb-form-control" type="text" name="customer_phone" autocomplete="off" placeholder="<?php echo esc_attr_x( 'Phone number', 'renting_complete', 'mybooking-reservation-engine') ?>" maxlength="15" value="<%=booking.customer_phone%>" 
...
<% } else { %>
  ...
  <div class="mb-form-row">
    <div class="mb-form-group mb-col-md-6">
      ...
      <!-- Customer name -->
      <input class="mb-form-control" type="text" name="customer_name" autocomplete="off" placeholder="<?php echo esc_attr_x( 'Name', 'renting_my_reservation', 'mybooking-reservation-engine') ?>" maxlength="40" value="<%=booking.customer_name%>" <% if (!booking.can_edit_online){%>disabled<%}%>  <% if (required_fields.includes('customer_name')) { %>required<% } %>>
    </div>
    <div class="mb-form-group mb-col-md-6">
      <label>
      ...
      <!-- Customer surname -->
      <input class="mb-form-control" type="text" name="customer_surname" autocomplete="off" placeholder="<?php echo esc_attr_x( 'Surname', 'renting_my_reservation', 'mybooking-reservation-engine') ?>" maxlength="40" value="<%=booking.customer_surname%>" <% if (!booking.can_edit_online){%>disabled<%}%>  <% if (required_fields.includes('customer_surname')) { %>required<% } %>>
    </div>
  </div>
  ...
  <h6>
    <?php echo esc_attr_x( 'ID card or passport', 'renting_my_reservation', 'mybooking-reservation-engine') ?>
  </h6>
  <hr />
  ...
  <div class="mb-form-row">
    ...
    <div class="mb-form-group mb-col-md-6">
      ...
      <input class="mb-form-control" type="text" name="customer_document_id" id="customer_document_id"
        autocomplete="off" placeholder="<?php echo esc_attr_x( 'ID card/passport number', 'renting_my_reservation', 'mybooking-reservation-engine') ?>" value="<%=booking.customer_document_id%>" <% if (!booking.can_edit_online){%>disabled<%}%> <% if (required_fields.includes('customer_document_id')) { %>required<% } %>>
    </div>
  </div>
...
<div class="mb-form-row">
  ...
  <div class="mb-form-group mb-col-md-6">
    ...
    <input class="mb-form-control" name="customer_address[state]" type="text"
      placeholder="<%=configuration.escapeHtml("<?php echo esc_attr_x( 'State', 'renting_my_reservation', 'mybooking-reservation-engine') ?>")%>" 
...
<div class="mb-form-row">
  ...
  <div class="mb-form-group mb-col-md-6">
    ...
    <input class="mb-form-control" name="customer_address[city]" type="text"
      placeholder="<%=configuration.escapeHtml("<?php echo esc_attr_x( 'City', 'renting_my_reservation', 'mybooking-reservation-engine') ?>")%>" 
  ...
  <div class="mb-form-group mb-col-md-6">
    <label>
      <?php echo esc_html_x( 'Postal Code', 'renting_my_reservation', 'mybooking-reservation-engine') ?>
      <% if (required_fields.includes('customer_address[zip]')) { %>*<% } %>
    </label>
    <input class="mb-form-control" name="customer_address[zip]" type="text"
      placeholder="<%=configuration.escapeHtml("<?php echo esc_attr_x( 'Postal Code', 'renting_my_reservation', 'mybooking-reservation-engine') ?>")%>" value="<%=booking.address_zip%>"  maxlength="10" <% if (!booking.can_edit_online){%>disabled<%}%> <% if (required_fields.includes('customer_address[zip]')) { %>required<% } %>>
  </div>
</div>
...
<div class="mb-form-row">
  ...
  <div class="mb-form-group mb-col-md-6">
    ...
    <input class="mb-form-control" name="customer_address[street]" type="text"
      placeholder="<%=configuration.escapeHtml("<?php echo esc_attr_x( 'Street', 'renting_my_reservation', 'mybooking-reservation-engine') ?>")%>" value="<%=booking.address_street%>" maxlength="60" <% if (!booking.can_edit_online){%>disabled<%}%> <% if (required_fields.includes('customer_address[street]')) { %>required<% } %>>
  </div>
  ...
  <div class="mb-form-group mb-col-md-3">
    ...
    <input class="mb-form-control" name="customer_address[number]" type="text"
      placeholder="<%=configuration.escapeHtml("<?php echo esc_attr_x( 'Number', 'renting_my_reservation', 'mybooking-reservation-engine') ?>")%>" value="<%=booking.address_number%>" maxlength="10" <% if (!booking.can_edit_online){%>disabled<%}%> <% if (required_fields.includes('customer_address[number]')) { %>required<% } %>>
  </div>
  ...
  <div class="mb-form-group mb-col-md-3">
    ...
    <input class="mb-form-control" name="customer_address[complement]" type="text"
      placeholder="<%=configuration.escapeHtml("<?php echo esc_attr_x( 'Complement', 'renting_my_reservation', 'mybooking-reservation-engine') ?>")%>" value="<%=booking.address_complement%>"  maxlength="20" <% if (!booking.can_edit_online){%>disabled<%}%> <% if (required_fields.includes('customer_address[complement]')) { %>required<% } %>>
  </div>
</div>