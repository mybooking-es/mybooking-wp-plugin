    ...
    <div class="col-md-8">
      <div class="shadow mb-5 bg-white rounded">
          ...
          <div class="p-3">
            ...
            <h2 class="h4 mt-3 text-danger font-weight-normal"><?php echo wp_kses_post( sprintf( _x('From <b>%s</b>', 'renting_product_detail', 'mybooking-wp-plugin' ), number_format_i18n( $args->from_price ) ) )?>€</h2>
            <?php } ?>
            <!-- Key characteristics -->
            ...
            <?php if ( !empty( $args->description ) ) { ?>
              <hr>
              <div class="mt-3">
                <h2 class="h3 mb-3"><?php echo esc_html_x('Details', 'renting_product_detail', 'mybooking-wp-plugin' ) ?></h2>
