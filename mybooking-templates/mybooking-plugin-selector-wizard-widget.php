    <section class="section">
      ...
      <div class="container">
        <form name="wizard_search_form" class="mt-5">
            ...
            <div class="row">
              <div class="col-md-3">
                  <label for="place_holder"><?php echo _x( 'Where?', 'renting_form_selector_wizard', 'mybooking-wp-plugin') ?></label>
                  <input type="text" class="form-control form-control-lg bg-white" id="place_holder" 
                         aria-describedby="pickupPlaceHolder" placeholder="<?php echo _x( 'Select a location', 'renting_form_selector_wizard', 'mybooking-wp-plugin') ?>" readonly="true">
              </div>
              <div class="col-md-3">
                  <label for="from_holder"><?php echo _x( 'When?', 'renting_form_selector_wizard', 'mybooking-wp-plugin') ?></label>
                  <input type="text" class="form-control form-control-lg bg-white" id="from_holder" 
                         aria-describedby="FromHolder" placeholder="<?php echo _x( 'Select dates', 'renting_form_selector_wizard', 'mybooking-wp-plugin') ?>" readonly="true">
              </div>    
              <br>
