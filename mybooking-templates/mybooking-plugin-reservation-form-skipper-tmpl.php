...
<% if (configuration.rentingFormFillDataDriverDetail && !booking.has_optional_external_driver) { %>
	<div id="driver_panel" class="mb-section mb-panel-container">
		<h3 class="mb-form_title">
			<?php echo esc_html_x('Skipper', 'renting_my_reservation', 'mybooking-reservation-engine') ?>
		</h3>
		<div class="mb-form-row">
			<div class="mb-form-group mb-col-md-6">
			<label for="driver_name"><?php echo esc_html_x('Name', 'renting_my_reservation', 'mybooking-reservation-engine') ?>
			...
			<div class="mb-form-group mb-col-md-6">
			<label for="driver_surname"><?php echo esc_html_x('Surname', 'renting_my_reservation', 'mybooking-reservation-engine') ?>
		...
		<div class="mb-form-row">
			...
			<label for="driver_document_id"><?php echo esc_html_x('ID card/passport number', 'renting_my_reservation', 'mybooking-reservation-engine') ?>
