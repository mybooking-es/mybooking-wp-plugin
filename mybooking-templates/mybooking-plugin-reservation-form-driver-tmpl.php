	...
	<div id="driver_panel" class="mb-section mb-panel-container">
		...
		<div class="mb-form-row" >
			<div class="mb-form-group mb-col-md-6">
				...
				<input class="form-control" name="driver_name" type="text"
					placeholder="<%=configuration.escapeHtml("<?php echo esc_attr_x("Name", 'renting_my_reservation', 'mybooking-reservation-engine') ?>")%>" value="<%=booking.driver_name%>"
			...
			<div class="mb-form-group mb-col-md-6">
				...
				<input class="form-control" name="driver_surname" type="text"
					placeholder="<%=configuration.escapeHtml("<?php  echo esc_attr_x("Surname", 'renting_my_reservation', 'mybooking-reservation-engine') ?>")%>" value="<%=booking.driver_surname%>"
		...
		<div class="mb-form-row">
			<div class="mb-form-group mb-col-md-6">
				...
				<input class="mb-form-control" type="text" name="driver_email" autocomplete="off" placeholder="<?php echo esc_attr_x( 'E-mail', 'renting_complete', 'mybooking-reservation-engine') ?>" maxlength="50" value="<%=booking.driver_email%>" 
			...
			<div class="mb-form-group mb-col-md-6">
				...
				<input class="mb-form-control" type="text" name="driver_phone" autocomplete="off" 
							placeholder="<?php echo esc_attr_x( 'Phone number', 'renting_complete', 'mybooking-reservation-engine') ?>" 
		...
		<div class="mb-form-row">
			...
			<div class="mb-form-group mb-col-md-4" >
				...
				<input class="form-control" name="driver_document_id" id="driver_document_id" type="text"
					placeholder="<%=configuration.escapeHtml("<?php echo esc_attr_x("ID card/passport number", 'renting_my_reservation', 'mybooking-reservation-engine') ?>")%>" value="<%=booking.driver_document_id%>"
		...
		<h6>
			<%=configuration.escapeHtml("<?php echo esc_attr_x('License', 'renting_my_reservation', 'mybooking-reservation-engine') ?>")%>
		</h6>
		<hr />
		<div class="mb-form-row">
			<div class="mb-form-group mb-col-md-4">
			...
			<div class="mb-form-group mb-col-md-4">
				...
				<input class="form-control" name="driver_driving_license_number"
					type="text" placeholder="<%=configuration.escapeHtml("<?php echo esc_attr_x('Driving license number', 'renting_my_reservation', 'mybooking-reservation-engine') ?>")%>"
			...
			<div class="mb-form-row">
				...
				<div class="mb-form-group mb-col-md-6">
					...
					<input class="form-control" name="driver_address[zip]" type="text"
						placeholder="<%=configuration.escapeHtml("<?php echo esc_attr_x( 'Postal Code', 'renting_my_reservation', 'mybooking-reservation-engine') ?>")%>" value="<%=booking.driver_address_zip%>"  maxlength="10" <% if (!booking.can_edit_online){%>disabled<%}%> <% if (required_fields.includes('driver_address[zip]')) { %>required<% } %>>
				</div>
			</div>
			...
			<div class="mb-form-row">
				...
				<div class="mb-form-group mb-col-md-6">
					...
					<input class="form-control" name="driver_address[street]" type="text"
						placeholder="<%=configuration.escapeHtml("<?php echo esc_attr_x( 'Street', 'renting_my_reservation', 'mybooking-reservation-engine') ?>")%>" value="<%=booking.driver_address_street%>" maxlength="60" <% if (!booking.can_edit_online){%>disabled<%}%> <% if (required_fields.includes('driver_address[street]')) { %>required<% } %>>
				</div>
				...
				<div class="mb-form-group mb-col-md-3">
					...
					<input class="form-control" name="driver_address[number]" type="text"
						placeholder="<%=configuration.escapeHtml("<?php echo esc_attr_x( 'Number', 'renting_my_reservation', 'mybooking-reservation-engine') ?>")%>" value="<%=booking.driver_address_number%>" maxlength="10" <% if (!booking.can_edit_online){%>disabled<%}%> <% if (required_fields.includes('driver_address[number]')) { %>required<% } %>>
				</div>
				...
				<div class="mb-form-group mb-col-md-3">
					...
					<input class="form-control" name="driver_address[complement]" type="text"
						placeholder="<%=configuration.escapeHtml("<?php echo esc_attr_x( 'Complement', 'renting_my_reservation', 'mybooking-reservation-engine') ?>")%>" value="<%=booking.driver_address_complement%>"  maxlength="20" <% if (!booking.can_edit_online){%>disabled<%}%> <% if (required_fields.includes('driver_address[complement]')) { %>required<% } %>>
				</div>
			</div>
		<% } %>
	</div>
