        ...
        <div id="customers_data" class="mb-section mb-panel-container">
          <form class="mybooking-form" id="order_information_form" name="order_information_form">
            <div class="mb-alert lighter">
              <?php echo esc_html_x( 'Please complete the information to speed up the delivery process on the scheduled date', 'activity_my_reservation', 'mybooking-reservation-engine') ?>
            </div>

            <!-- // Address -->
            <% if (order.request_customer_address) { %>
              <h3 class="mb-form_title">
                <?php echo esc_html_x( 'Customer address', 'activity_my_reservation', 'mybooking-reservation-engine') ?>
              </h3>
              ...
              <!-- Country -->
                <div class="mb-form-group mb-col-md-6">
                  <label for="country">
                    <?php echo esc_html_x( 'Country', 'activity_my_reservation', 'mybooking-reservation-engine') ?>
                  </label>
                ...
                <div class="mb-form-group mb-col-md-6">
                  <label for="state">
                    <?php echo esc_html_x( 'State', 'activity_my_reservation', 'mybooking-reservation-engine') ?>
                  </label>
                  ...
                  <input class="mb-form-control" id="state" name="customer_address[state]" type="text"
                    placeholder="<%=configuration.escapeHtml("<?php echo esc_attr_x( 'State', 'activity_my_reservation', 'mybooking-reservation-engine') ?>")%>" 
              ...
              <div class="mb-form-row">
                ...
                <div class="mb-form-group mb-col-md-6">
                  <label for="city">
                    <?php echo esc_html_x( 'City', 'activity_my_reservation', 'mybooking-reservation-engine') ?>
                  </label>
                  <% if (configuration.sesHospedajes) { %>
                  ...
                  <input class="mb-form-control" id="city" name="customer_address[city]" type="text"
                    placeholder="<%=configuration.escapeHtml("<?php echo esc_attr_x( 'City', 'activity_my_reservation', 'mybooking-reservation-engine') ?>")%>" 
                ...
                <div class="mb-form-group mb-col-md-6">
                  <label for="zip">
                    <?php echo esc_html_x( 'Postal Code', 'activity_my_reservation', 'mybooking-reservation-engine') ?>
                  </label>
                  <input class="mb-form-control" id="zip" name="customer_address[zip]" type="text"
                    placeholder="<%=configuration.escapeHtml("<?php echo esc_attr_x( 'Postal Code', 'activity_my_reservation', 'mybooking-reservation-engine') ?>")%>" value="<%=order.address_zip%>"  max_length="10">
                </div>
              </div>
              ...
              <div class="mb-form-row">
                ...
                <div class="mb-form-group mb-col-md-6">
                  <label for="street">
                    <?php echo esc_html_x( 'Address', 'activity_my_reservation', 'mybooking-reservation-engine') ?>
                  </label>
                  <input class="mb-form-control" id="street" name="customer_address[street]" type="text"
                    placeholder="<%=configuration.escapeHtml("<?php echo esc_attr_x( 'Address', 'activity_my_reservation', 'mybooking-reservation-engine') ?>")%>" value="<%=order.address_street%>" maxlength="60">
                </div>

                <!-- Number -->
                <div class="mb-form-group mb-col-md-3">
                  <label for="number">
                    <?php echo esc_html_x( 'Number', 'activity_my_reservation', 'mybooking-reservation-engine') ?>
                  </label>
                  <input class="mb-form-control" id="number" name="customer_address[number]" type="text"
                    placeholder="<%=configuration.escapeHtml("<?php echo esc_attr_x( 'Number', 'activity_my_reservation', 'mybooking-reservation-engine') ?>")%>" value="<%=order.address_number%>" maxlength="10">
                </div>

                <!-- Complement -->
                <div class="mb-form-group mb-col-md-3">
                  <label for="complement">
                    <?php echo esc_html_x( 'Complement', 'activity_my_reservation', 'mybooking-reservation-engine') ?>
                  </label>
                  <input class="mb-form-control" id="complement" name="customer_address[complement]" type="text"
                    placeholder="<%=configuration.escapeHtml("<?php echo esc_attr_x( 'Complement', 'activity_my_reservation', 'mybooking-reservation-engine') ?>")%>" value="<%=order.address_complement%>"  max_length="20">
                </div>
              </div>
            <% } %>
                ...
                <% if (typeof order.items[idx].customers !== 'undefined' && typeof order.items[idx].customer_questions !== 'undefined') { %>
                  ...
                  <% for (var idxCustomers=0; idxCustomers<order.items[idx].customers.length; idxCustomers++) { %>
                      ...
                      <h4 class="mb-form_tile mb-alert lighter">
                        <?php echo esc_html_x( 'Participant', 'activity_my_reservation', 'mybooking-reservation-engine' ) ?> #<%=index%>
                      </h4>

                      <div class="mb-form-row">
                        <div class="mb-form-group mb-col-md-6">
                          <label for="customer_name"><?php echo esc_html_x( 'Name', 'activity_my_reservation', 'mybooking-reservation-engine') ?></label>
                          <input name="order_item_customers[<%=index%>][customer_name]"
                                  title="<?php echo esc_attr_x( 'Name', 'activity_my_reservation', 'mybooking-reservation-engine') ?>" data-toggle="tooltip"
                                  class="mb-form-control" type="text"
                                  placeholder="<?php echo esc_attr_x( 'Name', 'activity_my_reservation', 'mybooking-reservation-engine') ?>:" maxlength="80"
                                  value="<%=order_item_customer.customer_name%>">
                        </div>
                        <div class="mb-form-group mb-col-md-6">
                          <label for="customer_name"><?php echo esc_html_x( 'Surname', 'activity_my_reservation', 'mybooking-reservation-engine') ?></label>
                          <input name="order_item_customers[<%=index%>][customer_surname]"
                                  title="<?php echo esc_attr_x( 'Surname', 'activity_my_reservation', 'mybooking-reservation-engine') ?>" data-toggle="tooltip"
                                  class="mb-form-control" type="text"
                                  placeholder="<?php echo esc_attr_x( 'Surname', 'activity_my_reservation', 'mybooking-reservation-engine') ?>:" maxlength="80"
                      ...
                      <div class="mb-form-row">
                        <% if (customer_questions.request_customer_document_id) { %>
                          <div class="mb-form-group mb-col-md-6">
                            <label for="customer_document_id"><?php echo esc_html_x( 'Document ID', 'activity_my_reservation', 'mybooking-reservation-engine') ?></label>
                            <input name="order_item_customers[<%=index%>][customer_document_id]"
                                    title="<?php echo esc_attr_x( 'Document ID', 'activity_my_reservation', 'mybooking-reservation-engine') ?>" data-toggle="tooltip"
                                    class="mb-form-control" type="text"
                                    placeholder="<?php echo esc_attr_x( 'Document ID', 'activity_my_reservation', 'mybooking-reservation-engine') ?>:" maxlength="50"
                        ...
                        <% if (customer_questions.request_customer_date_of_birth) { %>
                          <div class="mb-form-group mb-col-md-6">
                            <label for="customer_date_of_birth"><?php echo esc_html_x( 'Date of birth', 'activity_my_reservation', 'mybooking-reservation-engine') ?></label>
                            <input name="order_item_customers[<%=index%>][customer_date_of_birth]"
                                    title="<?php echo esc_attr_x( 'Date of birth', 'activity_my_reservation', 'mybooking-reservation-engine') ?>" data-toggle="tooltip"
                                    class="mb-form-control" type="date"
                                    placeholder="<?php echo esc_attr_x( 'Date of birth', 'activity_my_reservation', 'mybooking-reservation-engine') ?>:" maxlength="50"
                      ...
                      <div class="mb-form-row">
                        ...
                        <% if (customer_questions.request_customer_phone) { %>
                          <div class="mb-form-group mb-col-md-6">
                            <label for="customer_phone"><?php echo esc_html_x( 'Phone number', 'activity_my_reservation', 'mybooking-reservation-engine') ?></label>
                            <input name="order_item_customers[<%=index%>][customer_phone]"
                                    title="<?php echo esc_attr_x( 'Phone number', 'activity_my_reservation', 'mybooking-reservation-engine') ?>" data-toggle="tooltip"
                                    class="mb-form-control" type="text"
                                    placeholder="<?php echo esc_attr_x( 'Phone number', 'activity_my_reservation', 'mybooking-reservation-engine') ?>:" maxlength="50"
                        ...
                        <% if (customer_questions.request_customer_email) { %>
                          <div class="mb-form-group mb-col-md-6">
                            <label for="customer_email"><?php echo esc_html_x( 'E-mail', 'activity_my_reservation', 'mybooking-reservation-engine') ?></label>
                            <input name="order_item_customers[<%=index%>][customer_email]"
                                    title="<?php echo esc_attr_x( 'E-mail', 'activity_my_reservation', 'mybooking-reservation-engine') ?>" data-toggle="tooltip"
                                    class="mb-form-control" type="text"
                                    placeholder="<?php echo esc_attr_x( 'E-mail', 'activity_my_reservation', 'mybooking-reservation-engine') ?>:" maxlength="50"
                      ...
                      <% if (customer_questions.request_customer_height || customer_questions.request_customer_weight) { %>
                        <div class="mb-form-row">
                          <% if (customer_questions.request_customer_height) { %>
                            <div class="mb-form-group mb-col-md-6">
                              <label for="customer_height"><?php echo esc_html_x( 'Height (cm)', 'activity_my_reservation', 'mybooking-reservation-engine') ?></label>
                              <input name="order_item_customers[<%=index%>][customer_height]"
                                      title="<?php echo esc_attr_x( 'Height (cm)', 'activity_my_reservation', 'mybooking-reservation-engine') ?>" data-toggle="tooltip"
                                      class="mb-form-control" type="number"
                                      placeholder="<?php echo esc_attr_x( 'Height (cm)', 'activity_my_reservation', 'mybooking-reservation-engine') ?>:" min="0" max="250"
                          ...
                          <% if (customer_questions.request_customer_weight) { %>
                            <div class="mb-form-group mb-col-md-6">
                              <label for="customer_weight"><?php echo esc_html_x( 'Weight (kg)', 'activity_my_reservation', 'mybooking-reservation-engine') ?></label>
                              <input name="order_item_customers[<%=index%>][customer_weight]"
                                      title="<?php echo esc_attr_x( 'Weight (kg)', 'activity_my_reservation', 'mybooking-reservation-engine') ?>" data-toggle="tooltip"
                                      class="mb-form-control" type="number"
                                      placeholder="<?php echo esc_attr_x( 'Weight (kg)', 'activity_my_reservation', 'mybooking-reservation-engine') ?>:" min="0" max="200"
                          ...
                          <div class="mb-form-group mb-col-md-3">
                            <div class="mb-form_checkbox">
                              <input name="order_item_customers[<%=index%>][customer_allergies]"
                                      title="<?php echo esc_html_x( 'Allergies', 'activity_my_reservation', 'mybooking-reservation-engine') ?>" data-toggle="tooltip"
                                      class="mb-input_checkbox" type="checkbox"
                                      <% if (order_item_customer.customer_allergies){%>checked<%}%>>
                              <label for="customer_allergies" class="form-check-label"><?php echo esc_html_x( 'Allergies', 'activity_my_reservation', 'mybooking-reservation-engine') ?></label>
                            </div>
                          </div>
                          <div class="mb-form-group mb-col-md-9">
                              <label for="customer_allergies_detail"><?php echo esc_html_x( 'Allergies detail', 'activity_my_reservation', 'mybooking-reservation-engine') ?></label>
                              <textarea name="order_item_customers[<%=index%>][customer_allergies_detail]"
                                        title="<?php echo esc_attr_x( 'Allergies detail', 'activity_my_reservation', 'mybooking-reservation-engine') ?>" data-toggle="tooltip"
                                        class="mb-form-control" type="number"
                                        placeholder="<?php echo esc_attr_x( 'Allergies detail', 'activity_my_reservation', 'mybooking-reservation-engine') ?>:" rows="5"><%=order_item_customer.customer_allergies_detail%></textarea>
                          </div>
                        </div>
                        <div class="mb-form-row">
                          <div class="mb-form-group mb-col-md-3">
                            <div class="mb-form_checkbox">
                              <input name="order_item_customers[<%=index%>][customer_intolerances]"
                                      title="<?php echo esc_attr_x( 'Intolerances', 'activity_my_reservation', 'mybooking-reservation-engine') ?>" data-toggle="tooltip"
                                      class="mb-input_checkbox" type="checkbox"
                                      <% if (order_item_customer.customer_intolerances){%>checked<%}%>>
                              <label for="customer_intolerances" class="form-check-label"><?php echo esc_html_x( 'Intolerances', 'activity_my_reservation', 'mybooking-reservation-engine') ?></label>
                            </div>
                          </div>
                          <div class="mb-form-group mb-col-md-9">
                              <label for="customer_intolerances_detail"><?php echo esc_html_x( 'Intolerances detail', 'activity_my_reservation', 'mybooking-reservation-engine') ?></label>
                              <textarea name="order_item_customers[<%=index%>][customer_intolerances_detail]"
                                        title="<?php echo esc_attr_x( 'Intolerances detail', 'activity_my_reservation', 'mybooking-reservation-engine') ?>" data-toggle="tooltip"
                                        class="mb-form-control" type="number"
                                        placeholder="<?php echo esc_attr_x( 'Intolerances detail', 'activity_my_reservation', 'mybooking-reservation-engine') ?>:" rows="5"><%=order_item_customer.customer_intolerances_detail%></textarea>
                          </div>
                        </div>
                      <% } %>
                          ...
                          <div class="mb-form-group mb-col-md-3">
                            <div class="mb-form_checkbox">
                              <input name="order_item_customers[<%=index%>][customer_slight_injuries]"
                                      title="<?php echo esc_attr_x( 'Slight injuries', 'activity_my_reservation', 'mybooking-reservation-engine') ?>" data-toggle="tooltip"
                                      class="mb-input_checkbox" type="checkbox"
                                      <% if (order_item_customer.customer_slight_injuries){%>checked<%}%>>
                              <label for="customer_slight_injuries" class="form-check-label"><?php echo esc_html_x( 'Slight injuries', 'activity_my_reservation', 'mybooking-reservation-engine') ?></label>
                            </div>
                          </div>
                          <div class="mb-form-group mb-col-md-9">
                              <label for="customer_slight_injuries_detail"><?php echo esc_html_x( 'Slight injuries detail', 'activity_my_reservation', 'mybooking-reservation-engine') ?></label>
                              <textarea name="order_item_customers[<%=index%>][customer_slight_injuries_detail]"
                                        title="<?php echo esc_attr_x( 'Slight injuries detail', 'activity_my_reservation', 'mybooking-reservation-engine') ?>" data-toggle="tooltip"
                                        class="mb-form-control" type="number"
                                        placeholder="<?php echo esc_attr_x( 'Slight injuries detail', 'activity_my_reservation', 'mybooking-reservation-engine') ?>:" rows="5"><%=order_item_customer.customer_slight_injuries_detail%></textarea>
                          </div>
                        </div>
                      <% } %>
                          ...
                          <div class="mb-form-group mb-col-md-3">
                            <div class="mb-form_checkbox">
                              <input name="order_item_customers[<%=index%>][customer_diseases]"
                                      title="<?php echo esc_attr_x( 'Diseases', 'activity_my_reservation', 'mybooking-reservation-engine') ?>" data-toggle="tooltip"
                                      class="mb-input_checkbox" type="checkbox"
                                      <% if (order_item_customer.customer_diseases){%>checked<%}%>>
                              <label for="customer_diseases" class="form-check-label"><?php echo esc_html_x( 'Diseases', 'activity_my_reservation', 'mybooking-reservation-engine') ?></label>
                            </div>
                          </div>
                          <div class="mb-form-group mb-col-md-9">
                              <label for="customer_diseases_detail"><?php echo esc_html_x( 'Diseases detail', 'activity_my_reservation', 'mybooking-reservation-engine') ?></label>
                              <textarea name="order_item_customers[<%=index%>][customer_diseases_detail]"
                                        title="<?php echo esc_attr_x( 'Diseases detail', 'activity_my_reservation', 'mybooking-reservation-engine') ?>" data-toggle="tooltip"
                                        class="mb-form-control" type="number"
                                        placeholder="<?php echo esc_attr_x( 'Diseases detail', 'activity_my_reservation', 'mybooking-reservation-engine') ?>:" rows="5"><%=order_item_customer.customer_diseases_detail%></textarea>
                          </div>
                        </div>
                      <% } %>
                        ...
                        <div class="mb-form-row">
                            ...
                            <div class="mb-form-group mb-col-md-6">
                              ...
                              <select name="order_item_customers[<%=index%>][customer_experience_product_1]"
                                ...
                                <option value=""><?php echo esc_html_x( 'Select the option', 'activity_my_reservation', 'mybooking-reservation-engine') ?></option>
                                <option value="0" <% if (order_item_customer.customer_experience_product_1 == '0'){%>selected<%}%>><?php echo esc_html_x( 'Never', 'activity_my_reservation', 'mybooking-reservation-engine') ?></option>
                                <option value="1" <% if (order_item_customer.customer_experience_product_1 == '1'){%>selected<%}%>><?php echo esc_html_x( 'Once', 'activity_my_reservation', 'mybooking-reservation-engine') ?></option>
                                <option value="2" <% if (order_item_customer.customer_experience_product_1 == '2'){%>selected<%}%>><?php echo esc_html_x( 'Twice', 'activity_my_reservation', 'mybooking-reservation-engine') ?></option>
                                <option value="3" <% if (order_item_customer.customer_experience_product_1 == '3'){%>selected<%}%>><?php echo esc_html_x( 'Three or more times', 'activity_my_reservation', 'mybooking-reservation-engine') ?></option>
                              </select>
                            </div>
                            <% } %>
                            ...
                            <div class="mb-form-group mb-col-md-6">
                              ...
                              <select name="order_item_customers[<%=index%>][customer_experience_product_2]"
                                      class="mb-form-control">
                                <option value=""><?php echo esc_html_x( 'Select the option', 'activity_my_reservation', 'mybooking-reservation-engine') ?></option>
                                <option value="0" <% if (order_item_customer.customer_experience_product_2 == '0'){%>selected<%}%>><?php echo esc_html_x( 'Never', 'activity_my_reservation', 'mybooking-reservation-engine') ?></option>
                                <option value="1" <% if (order_item_customer.customer_experience_product_2 == '1'){%>selected<%}%>><?php echo esc_html_x( 'Once', 'activity_my_reservation', 'mybooking-reservation-engine') ?></option>
                                <option value="2" <% if (order_item_customer.customer_experience_product_2 == '2'){%>selected<%}%>><?php echo esc_html_x( 'Twice', 'activity_my_reservation', 'mybooking-reservation-engine') ?></option>
                                <option value="3" <% if (order_item_customer.customer_experience_product_2 == '3'){%>selected<%}%>><?php echo esc_html_x( 'Three or more times', 'activity_my_reservation', 'mybooking-reservation-engine') ?></option>
                              </select>
                            </div>
                            <% } %>
                        </div>
                      ...
                      <div class="mb-form-row">
                        ...
                        <div class="mb-form-group mb-col-md-6">
                          ...
                          <select name="order_item_customers[<%=index%>][customer_experience_tecnical_course]"
                                  class="mb-form-control">
                            <option value=""><?php echo esc_html_x( 'Select the option', 'activity_my_reservation', 'mybooking-reservation-engine') ?></option>
                            <option value="false" <% if (!order_item_customer.customer_experience_tecnical_course){%>selected<%}%>><?php echo esc_html_x( 'No', 'activity_my_reservation', 'mybooking-reservation-engine') ?></option>
                            <option value="true" <% if (order_item_customer.customer_experience_tecnical_course){%>selected<%}%>><?php echo esc_html_x( 'Yes', 'activity_my_reservation', 'mybooking-reservation-engine') ?></option>
                          </select>
                        </div>
                        <% } %>
                        ...
                        <div class="mb-form-group mb-col-md-6">
                          ...
                          <select name="order_item_customers[<%=index%>][customer_experience_activities]"
                                  class="mb-form-control">
                            <option value=""><?php echo esc_html_x( 'Select the option', 'activity_my_reservation', 'mybooking-reservation-engine') ?></option>
                            <option value="false" <% if (!order_item_customer.customer_experience_activities){%>selected<%}%>><?php echo esc_html_x( 'No', 'activity_my_reservation', 'mybooking-reservation-engine') ?></option>
                            <option value="true" <% if (order_item_customer.customer_experience_activities){%>selected<%}%>><?php echo esc_html_x( 'Yes', 'activity_my_reservation', 'mybooking-reservation-engine') ?></option>
                          </select>
                        </div>
                        <% } %>
                      </div>
            ...
            <button class="mb-button" id="btn_update_order" type="button">
              <?php echo esc_html_x( 'Update', 'activity_my_reservation', 'mybooking-reservation-engine') ?>
            </button>
          </form>
        </div>
      <% } %>
            ...
            <div id="payment_now_container">
              ...
              <% if (order.payment_methods.paypal_standard && order.payment_methods.tpv_virtual) { %>
                ...
                <label class="mybooking-payment_custom-label" for="payments_credit_card">
                  ...
                  <input type="radio" id="payments_credit_card" name="payment_method_select" class="payment_method_select" value="<%=order.payment_methods.tpv_virtual%>"><?php echo wp_kses_post( _x( 'Credit or debit card', 'renting_complete', 'mybooking-reservation-engine' ) ) ?>
                </label>
                </div>
                <div class="mb-row">
