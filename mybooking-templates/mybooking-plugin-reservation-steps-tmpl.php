...
<script type="text/tmpl" id="script_reservation_steps">
  <div style="margin: 2rem;">
    ...
    <ul class="mb--steps-wrapper">
      ...
      <li class="mb--step <% if (booking.required_data_completed && booking.customer_documents_uploaded && booking.engine_sign_contract) { %>mb--active<% } else if (booking.contract_signed) { %>mb--completed<% } else { %>mb--disabled<% } %>">
