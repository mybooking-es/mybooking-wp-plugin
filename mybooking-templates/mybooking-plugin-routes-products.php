			  ...
			  <div class="col-md-3">
					<div class="card text-center">
					  ...
					  <div class="card-body">
					    ...
					    <a href="/<? echo $args['url']?>/<?php echo $product->code?>" class="btn btn-primary">Más información</a>
					  </div>
					</div>
			  </div>
			<?  } ?>
		...
		<div class="row">
			<div class="col-md-12">
				<nav aria-label="Page navigation example" class="pull-right">
				  <ul class="pagination">
				    <li class="page-item <? if ($args['current_page'] == 1) { ?>disabled<? } ?>">
				    	  <a class="page-link" href="/<? echo $args['url']?>?page=<? echo $args['current_page']-1 ?>">Previous</a>
				    </li>
	          <? foreach ($args['pages'] as $page) { ?>
		          ...
		          <? } else { ?> 
		            <li class="page-item">
		      	      <a class="page-link" href="/<? echo $args['url']?>?page=<? echo $page ?>"><? echo $page ?></a>
		      	    </li>  
		      	  <? } ?>
				    <? } ?>	    
				    <li class="page-item <? if ($args['current_page'] == $args['total_pages']) { ?>disabled<? } ?>">
				    	  <a class="page-link" href="/<? echo $args['url']?>?page=<? echo $args['current_page']+1 ?>">Next</a>
				    </li>
				  </ul>
				</nav>
			</div>
