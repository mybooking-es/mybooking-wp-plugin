...
?>
<h3>
  <?php echo esc_html_x( 'Customer/Skipper', 'renting_my_reservation', 'mybooking-reservation-engine') ?>
</h3>
...
<div class="mb-form-row">
  ...
  <div class="mb-form-group mb-col-md-6">
    ...
    <input class="mb-form-control" type="text" name="driver_surname" autocomplete="off" 
           placeholder="<?php echo esc_attr_x( 'Surname', 'renting_my_reservation', 'mybooking-reservation-engine') ?>" maxlength="40" 
...
<div class="mb-form-row">
  ...
  <div class="mb-form-group mb-col-md-6">
    ...
    <input class="mb-form-control" type="text" name="driver_document_id" id="customer_driver_document_id"
     autocomplete="off" placeholder="<?php echo esc_attr_x( 'ID card/passport number', 'renting_my_reservation', 'mybooking-reservation-engine') ?>" value="<%=booking.driver_document_id%>" <% if (!booking.can_edit_online){%>disabled<%}%> <% if (required_fields.includes('driver_document_id')) { %>required<% } %>>
  </div>
</div>
...
<div class="mb-form-row">
  ...
  <div class="mb-form-group mb-col-md-6">
    ...
    <input class="mb-form-control" name="driver_address[zip]" type="text"
      placeholder="<%=configuration.escapeHtml("<?php echo esc_attr_x( 'Postal Code', 'renting_my_reservation', 'mybooking-reservation-engine') ?>")%>"
...
<div class="mb-form-row">
  ...
  <div class="mb-form-group mb-col-md-6">
    ...
    <input class="mb-form-control" name="driver_address[street]" type="text"
      placeholder="<%=configuration.escapeHtml("<?php echo esc_attr_x( 'Street', 'renting_my_reservation', 'mybooking-reservation-engine') ?>")%>" 
  ...
  <div class="mb-form-group mb-col-md-3">
    ...
    <input class="mb-form-control" name="driver_address[number]" type="text"
      placeholder="<%=configuration.escapeHtml("<?php echo esc_attr_x( 'Number', 'renting_my_reservation', 'mybooking-reservation-engine') ?>")%>" 
  ...
  <div class="mb-form-group mb-col-md-3">
    ...
    <input class="mb-form-control" name="driver_address[complement]" type="text"
      placeholder="<%=configuration.escapeHtml("<?php echo esc_attr_x( 'Complement', 'renting_my_reservation', 'mybooking-reservation-engine') ?>")%>"
...
<% if (typeof booking.item_driving_license_type_name !== 'undefined' && 
  ...
  <h6>
    <?php echo esc_html_x( 'Skipper data', 'renting_my_reservation', 'mybooking-reservation-engine') ?>
  </h6>
  <hr />
  ...
  <div class="mb-form-row">
    <div class="mb-form-row">
      <div class="mb-form-group mb-col-md-6">
      <label
        for="driver_driving_license_type"><?php echo esc_html_x('Navigation license type', 'renting_my_reservation', 'mybooking-reservation-engine') ?>
      ...
      <input class="form-control" id="driver_driving_license_type" name="driver_driving_license_type"
        type="text" placeholder="<%=configuration.escapeHtml("<?php echo esc_attr_x('Navigation license type', 'renting_my_reservation', 'mybooking-reservation-engine') ?>")%>"
      ...
      <div class="mb-form-group mb-col-md-6">
      <label
        for="driver_driving_license_number"><?php echo esc_html_x('Navigation license number', 'renting_my_reservation', 'mybooking-reservation-engine') ?>
