<?php
  ...
  class MyBookingUIActivitiesPages
  {
    ...
    /**
     * Create a "simulated" post with the activity detail
     */
    private function activity_content($data) {
          ...
          // Add the activity "simulated" post to the cache
