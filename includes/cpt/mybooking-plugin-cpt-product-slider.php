     ...
     */
	  private function register_post_type() {
        ...
        register_post_type( 'product-slider',
          array(
            'labels' => array(
              'name' => _x('Product Slider', 'slider_product', 'mybooking-reservation-engine'),
              'singular_name' => _x('Testimonial', 'slider_product', 'mybooking-reservation-engine'),
              'add_new' => _x('Add slider', 'slider_product', 'mybooking-reservation-engine'),
              'add_new_item' => _x('New slider', 'slider_product', 'mybooking-reservation-engine'),
              'edit' => _x('Edit', 'slider_product', 'mybooking-reservation-engine'),
              'edit_item' => _x('Edit slider', 'slider_product', 'mybooking-reservation-engine'),
              'new_item' => _x('New slider', 'slider_product', 'mybooking-reservation-engine'),
              'view' => _x('See', 'slider_product', 'mybooking-reservation-engine'),
              'view_item' => _x('See slider', 'slider_product', 'mybooking-reservation-engine'),
              'search_items' => _x('Search slider', 'slider_product', 'mybooking-reservation-engine'),
              'not_found' => _x('No slider found', 'slider_product', 'mybooking-reservation-engine'),
              'not_found_in_trash' => _x('No slider found on bin', 'slider_product', 'mybooking-reservation-engine'),
              'parent' => _x('Parent slider', 'slider_product', 'mybooking-reservation-engine')
            ),
            'show_ui' => true,
            'public' => true,
