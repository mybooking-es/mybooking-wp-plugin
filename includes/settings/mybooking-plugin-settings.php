  ...
  class MyBookingPluginSettings {
    ...
    private function wp_init() {
		...
		public function wp_settings_page() {
		  	add_menu_page(
				...
				add_submenu_page(
					...
					wp_kses_post( _x('Settings', 'plugin_settings', 'mybooking-reservation-engine') ),
					wp_kses_post( _x('Settings', 'plugin_settings', 'mybooking-reservation-engine') ),
					'manage_options',
		...
		?>
		  <div class="wrap">
		  	  <h1>
						<?php echo esc_html_x( 'Mybooking Settings', 'settings_context', 'mybooking-reservation-engine' ) ?>
					</h1>
					<p>
						<?php echo esc_html_x( 'Welcome to the settings page. After the initial configuration, this page will allow you to update some configurations that may change over time or add advanced modules and plugins.', 'settings_context', 'mybooking-reservation-engine' ) ?>
					</p>
					...
					<!-- Buttons -->
					<h2>
						<?php echo esc_html_x( 'Generated pages and components', 'settings_context', 'mybooking-reservation-engine' ) ?>
					</h2>
					<a href="<?php esc_attr(menu_page_url('mybooking-onboarding-pages'))?>">
						<?php echo esc_html_x( 'Pages', 'settings_context', 'mybooking-reservation-engine' ) ?>
					</a>
					&nbsp;
					<a href="<?php esc_attr(menu_page_url('mybooking-onboarding-components'))?>">
						<?php echo esc_html_x( 'Components', 'settings_context', 'mybooking-reservation-engine' ) ?>
					</a>
					<hr />
		      ...
		      <form action="options.php" method="POST">
	            ...
	            <?php	
	             if ($active_tab == 'connection_options') {
								...
								echo wp_kses_post( _x('<p>Set up your <b>Mybooking</b> account.</p>', 'settings_context', 'mybooking-reservation-engine' ) );
								echo '</div></div><hr />';								
			           ...
			           echo '</table>';
								 ...
								 echo '<br /><div class="postbox"><div class="inside">';
								 echo wp_kses_post( _x('<p>Configure the <b>renting/accommodation</b> module. It is done during the onboarding process but you can change the settings.</p>', 'settings_context', 'mybooking-reservation-engine' ) );
								 echo '</div></div><hr />';
			           ...
			           echo '</table>';
								 ...
								 echo '<br /><div class="postbox"><div class="inside">';
								 echo wp_kses_post( _x('<p>Configure the <b>activities/appointment</b> module. It is done during the onboarding process but you can change the settings.</p>', 'settings_context', 'mybooking-reservation-engine' ) );
								 echo '</div></div><hr />';
			           ...
			           echo '</table>';
								 ...
								 echo '<br /><div class="postbox"><div class="inside">';
								 echo wp_kses_post( _x('<p>Configure the <b>transfer</b> module. It is done during the onboarding process but you can change the settings.</p>', 'settings_context', 'mybooking-reservation-engine' ) );
								 echo '</div></div><hr />';
			           ...
			           echo '</table>';
								 ...
								 echo '<br /><div class="postbox"><div class="inside">';
								 echo wp_kses_post( _x('<p>Use <b>Google Captcha</b> to protect your contact forms from spam.</p>', 'settings_context', 'mybooking-reservation-engine' ) );
								 echo '</div></div><hr />';
			           ...
			           echo '</table>';
							 	 ...
							 	 echo '<br /><div class="postbox"><div class="inside">';
								 echo wp_kses_post( _x('<p>Use this basic complements to help you <b>improve</b> your reservations site.</p>', 'settings_context', 'mybooking-reservation-engine' ) );
								 echo '</div></div><hr />';
			           ...
			           echo '</table>';
								...
								echo '<br /><div class="postbox"><div class="inside">';
								echo wp_kses_post( _x('<p>Integrate reservation process with <b>third party</b> tools.</p>', 'settings_context', 'mybooking-reservation-engine' ) );
								echo '</div></div><hr />';								
								...
								echo '<br /><div class="postbox"><div class="inside">';
								echo wp_kses_post( _x('<p>Use <b>Google Api Places</b> to control delivery and collection custom address.</p>', 'settings_context', 'mybooking-reservation-engine' ) );
								echo '</div></div><hr />';
								...
								echo '</table>';
								 ...
								 echo '<br /><div class="postbox"><div class="inside">';
								 echo wp_kses_post( _x('<p><b>Compatibility</b> settings for devolopers. Set up if you find any conflict with this JS libraries.</p>', 'settings_context', 'mybooking-reservation-engine' ) );
								 echo '</div></div><hr />';
     ...
     *   - css
      ...
      // == Creates connection fields
		  ...
		  add_settings_field('mybooking_plugin_settings_account_id',
												 wp_kses_post( _x('Mybooking Client Id', 'plugin_settings', 'mybooking-reservation-engine') ),
		  ...
		  add_settings_field('mybooking_plugin_settings_api_key',
												 wp_kses_post( _x('Mybooking API Key', 'plugin_settings', 'mybooking-reservation-engine') ),
		                     array($this, 'field_mybooking_plugin_settings_api_key_callback'),
		                     'mybooking-plugin-configuration',
		                     'mybooking_plugin_settings_section_connection');

		  add_settings_field('mybooking_plugin_settings_sales_channel',
												 wp_kses_post( _x('Sales Channel Code', 'plugin_settings', 'mybooking-reservation-engine') ),
      ...
      // == Creates configuration fields
			...
			add_settings_field('mybooking_plugin_settings_google_api_places_selector',
												 wp_kses_post( _x('Google Api Places', 'plugin_settings', 'mybooking-reservation-engine') ),
      ...
      // == Creates renting wizard fields
		  ...
		  add_settings_field('mybooking_plugin_settings_choose_products_page',
												 wp_kses_post( _x('Choose products page', 'plugin_settings', 'mybooking-reservation-engine') ),
		  ...
		  add_settings_field('mybooking_plugin_settings_checkout_page',
												 wp_kses_post( _x('Checkout page', 'plugin_settings', 'mybooking-reservation-engine') ),
		  ...
		  add_settings_field('mybooking_plugin_settings_summary_page',
												 wp_kses_post( _x('Summary page', 'plugin_settings', 'mybooking-reservation-engine') ),
		                     array($this, 'field_mybooking_plugin_settings_summary_page_callback'),
		                     'mybooking-plugin-configuration',
		                     'mybooking_plugin_settings_section_renting');

		  add_settings_field('mybooking_plugin_settings_terms_page',
												 wp_kses_post( _x('Terms and conditions page', 'plugin_settings', 'mybooking-reservation-engine') ),
		  ...
		  add_settings_field('mybooking_plugin_settings_selector_in_process',
												 wp_kses_post( _x('Selector in process', 'plugin_settings', 'mybooking-reservation-engine') ),
		  ...
		  add_settings_field('mybooking_plugin_settings_show_taxes_included',
												 wp_kses_post( _x('Show taxes included', 'plugin_settings', 'mybooking-reservation-engine') ),
		  ...
		  add_settings_field('mybooking_plugin_settings_duration_context',
												 wp_kses_post( _x('Duration context', 'plugin_settings', 'mybooking-reservation-engine') ),
		  ...
		  add_settings_field('mybooking_plugin_settings_dates_context',
												 wp_kses_post( _x('Dates context', 'plugin_settings', 'mybooking-reservation-engine') ) ,
		  ...
		  add_settings_field('mybooking_plugin_settings_not_available_context',
												 wp_kses_post( _x('Not available context', 'plugin_settings', 'mybooking-reservation-engine') ),
			...
			add_settings_field('mybooking_plugin_settings_use_product_detail_pages',
												 wp_kses_post( _x('<em>Use product detail pages</em>', 'plugin_settings', 'mybooking-reservation-engine') ),
      ...
      // == Creates activities section fields
		  ...
		  add_settings_field('mybooking_plugin_settings_activities_terms_page',
												 wp_kses_post( _x('Terms & conditions page', 'plugin_settings', 'mybooking-reservation-engine') ),
		  ...
		  add_settings_field('mybooking_plugin_settings_use_activities_detail_pages',
												wp_kses_post( _x('<em>Use detail pages</em>', 'plugin_settings', 'mybooking-reservation-engine') ),
		  ...
		  add_settings_field('mybooking_plugin_settings_activities_url',
												 wp_kses_post( _x('<em>Detail pages URL prefix</em>', 'plugin_settings', 'mybooking-reservation-engine') ),
      ...
      // == Creates transfer wizard fields
		  ...
		  add_settings_field('mybooking_plugin_settings_transfer_choose_vehicle_page',
												 wp_kses_post( _x('Choose vehicle page', 'plugin_settings', 'mybooking-reservation-engine') ),
      ...
      // == Creates google api places fields
		  ...
		  add_settings_field('mybooking_plugin_settings_google_api_places_api_key',
												 wp_kses_post( _x('Api Key', 'plugin_settings', 'mybooking-reservation-engine') ),
		  ...
		  add_settings_field('mybooking_plugin_settings_google_api_places_restrict_country_code',
												 wp_kses_post( _x('Country code restriction', 'plugin_settings', 'mybooking-reservation-engine') ),
		  ...
		  add_settings_field('mybooking_plugin_settings_google_api_places_restrict_bounds',
												 wp_kses_post( _x('Restrict bounds', 'plugin_settings', 'mybooking-reservation-engine') ),
		  ...
		  add_settings_field('mybooking_plugin_settings_google_api_places_bounds_sw_lat',
												 wp_kses_post( _x('SW Latitude', 'plugin_settings', 'mybooking-reservation-engine') ),
		  ...
		  add_settings_field('mybooking_plugin_settings_google_api_places_bounds_sw_lng',
												 wp_kses_post( _x('SW Longitude', 'plugin_settings', 'mybooking-reservation-engine') ),
		  ...
		  add_settings_field('mybooking_plugin_settings_google_api_places_bounds_ne_lat',
												 wp_kses_post( _x('NE Latitude', 'plugin_settings', 'mybooking-reservation-engine') ),
		  ...
		  add_settings_field('mybooking_plugin_settings_google_api_places_bounds_ne_lng',
												 wp_kses_post( _x('NE Longitude', 'plugin_settings', 'mybooking-reservation-engine') ),
      ...
      add_settings_field('mybooking_plugin_settings_contact_form_include_google_captcha_js',
												 wp_kses_post( _x('Include Google Captcha JS library', 'plugin_settings', 'mybooking-reservation-engine') ),
      ...
      add_settings_field('mybooking_plugin_settings_complements_popup',
												 wp_kses_post( _x('Promotion Pop-up', 'plugin_settings', 'mybooking-reservation-engine') ),
      ...
      add_settings_field('mybooking_plugin_settings_complements_testimonials',
												 wp_kses_post( _x('Testimonial module', 'plugin_settings', 'mybooking-reservation-engine') ),
     ...
     add_settings_field('mybooking_plugin_settings_complements_product_slider',
		 										wp_kses_post( _x('Product Slider module', 'plugin_settings', 'mybooking-reservation-engine') ),
     ...
     add_settings_field('mybooking_plugin_settings_complements_content_slider',
		 										wp_kses_post( _x('Content Slider module', 'plugin_settings', 'mybooking-reservation-engine') ),
      ...
      add_settings_field('mybooking_plugin_settings_complements_cookies',
												 wp_kses_post( _x('Cookies Notice', 'plugin_settings', 'mybooking-reservation-engine') ),
		  ...
		  add_settings_field('mybooking_plugin_settings_components_js_slickjs',
												 wp_kses_post( _x('Include SlickJS', 'plugin_settings', 'mybooking-reservation-engine') ),
		  ...
		  add_settings_field('mybooking_plugin_settings_components_js_use_select2',
												 wp_kses_post( _x('Use select2 library on selects', 'plugin_settings', 'mybooking-reservation-engine') ),
    ...
    // == Renting
		...
		public function field_mybooking_plugin_settings_choose_products_page_callback() {
		  ...
		  echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'The page with [mybooking_rent_engine_product_listing] shortcode.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>.";
		}
		...
		public function field_mybooking_plugin_settings_checkout_page_callback() {
		  ...
		  echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'The page with [mybooking_rent_engine_complete] shortcode.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>.";
		}
		...
		public function field_mybooking_plugin_settings_summary_page_callback() {
		  ...
		  echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'The page with [mybooking_rent_engine_summary] shortcode.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>.";
		}
		...
		public function field_mybooking_plugin_settings_terms_page_callback() {
		  ...
		  echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'The terms and conditions page.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
		  echo "<hr />";
		}
        ...
        $value = '';
		  ...
		  $select .= "<option value=''>[";
			$select .= wp_kses_post( _x('Choose selector', 'plugin_settings', 'mybooking-reservation-engine') );
			$select .= "]</option>";

		  if ($value == 'wizard') {
		    $select .= "<option value='wizard' selected>";
				$select .= wp_kses_post( _x('Wizard', 'plugin_settings', 'mybooking-reservation-engine') );
				$select .= "</option>";
		  }
		  else {
		    ...
		    $select .= "<option value='form' selected>";
				$select .= wp_kses_post( _x('Form', 'plugin_settings', 'mybooking-reservation-engine') );
				$select .= "</option>";
		  }
		  else {
		  ...
		  echo "<p class=\"description\">";
			...
			echo "</p>";
		  echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'Select <b>wizard</b> if you are using the Wizard selector or widget on your home page.', 'settings_context', 'mybooking-reservation-engine' ) ); 
			echo "</p>";
		  echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'Select <b>form</b> if you are using the Form selector or widget on yout home page.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
		  echo "<hr />";
		}
      ...
      echo "<input type='hidden' name='mybooking_plugin_settings_renting[$field]' value=''/>";
		  ...
		  echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'Activate if you want to show taxes included literal in reservation.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
		  echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'Do not activate if you do not want to show taxes included literal in reservation.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
			echo "<hr />";
		}
        ...
        $value = '';
		  ...
		  $select = "<select name='mybooking_plugin_settings_renting[$field]'>";
		  $select .= "<option value=''>[";
			$select .= wp_kses_post( _x( 'Choose duration context', 'settings_context', 'mybooking-reservation-engine' ) );
			$select .= "]</option>";

		  if ($value == 'days') {
		    $select .= "<option value='days' selected>";
				$select .= wp_kses_post( _x( 'Days', 'settings_context', 'mybooking-reservation-engine' ) );
				$select .= "</option>";
		  }
		  else {
		    ...
		    $select .= "<option value='nights' selected>";
				$select .= wp_kses_post( _x( 'Nights', 'settings_context', 'mybooking-reservation-engine' ) );
				$select .= "</option>";
		  }
		  else {
		  ...
		  echo "<p class=\"description\">";
			...
			echo "</p>";
		  echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'Select <b>days</b> to describe duration in days.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
		  echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'Select <b>nights</b> to describe duration in nights.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
		}
        ...
        $value = '';
		  ...
		  $select = "<select name='mybooking_plugin_settings_renting[$field]'>";
		  $select .= "<option value=''>[";
			$select .= wp_kses_post( _x( 'Choose dates context', 'settings_context', 'mybooking-reservation-engine' ) );
			$select .= "]</option>";

		  if ($value == 'pickup-return') {
		    $select .= "<option value='pickup-return' selected>";
				$select .= wp_kses_post( _x( 'Pickup/Return', 'settings_context', 'mybooking-reservation-engine' ) );
				$select .= "</option>";
		  }
		  else {
		    ...
		    $select .= "<option value='checkin-checkout' selected>";
				$select .= wp_kses_post( _x( 'Checkin/Checkout', 'settings_context', 'mybooking-reservation-engine' ) );
				$select .= "</option>";
		  }
		  else {
		  ...
		  if ($value == 'start-end') {
		    $select .= "<option value='start-end' selected>";
				$select .= wp_kses_post( _x( 'Start/End', 'settings_context', 'mybooking-reservation-engine' ) );
				$select .= "</option>";
		  }
		  else {
		    ...
		    $select .= "<option value='arrive-departure' selected>";
				$select .= wp_kses_post( _x( 'Arrival/Depature', 'settings_context', 'mybooking-reservation-engine' ) );
				$select .= "</option>";
		  }
		  else {
		    ...
		    $select .= "<option value='departure-entry' selected>";
				$select .= wp_kses_post( _x( 'Departure/Entry', 'settings_context', 'mybooking-reservation-engine' ) );
				$select .= "</option>";
		  }
		  else {
		  ...
		  if ($value == 'eta-etd') {
		  	$select .= "<option value='eta-etd' selected>";
				$select .= wp_kses_post( _x( 'Estimated Time of Arrival / Departure', 'settings_context', 'mybooking-reservation-engine' ) );
				$select .= "</option>";
		  }
		  else {
		  ...
		  echo "<p class=\"description\">";
			...
			echo "</p>";
		  echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'Select <b>pickup/return</b> to describe pickup and return dates.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
		  echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'Select <b>checkin/checkout</b> for accommodation or properties.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
		  echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'Select <b>start/end</b> to describe start and end period.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo"</p>";
		  echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'Select <b>arrival/departure</b> to describe arrivals an departures', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
		  echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'Select <b>departure/entry</b> to describe departures and entries', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
		  echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'Select <b>eta/etd</b> to describe estimated arrival and departure times', 'settings_context', 'mybooking-reservation-engine' ) );
			echo"</p>";
		}
        ...
        $value = '';
		  ...
		  $select = "<select name='mybooking_plugin_settings_renting[$field]'>";
		  $select .= "<option value=''>[";
			$select .= wp_kses_post( _x( 'Choose not available context', 'settings_context', 'mybooking-reservation-engine' ) );
			$select .= "]</option>";

		  if ($value == 'not-available') {
		    $select .= "<option value='not-available' selected>";
				$select .= wp_kses_post( _x( 'Not available', 'settings_context', 'mybooking-reservation-engine' ) );
				$select .= "</option>";
		  }
		  else {
		    ...
		    $select .= "<option value='check-by-phone' selected>";
				$select .= wp_kses_post( _x( 'Telephone consultation', 'settings_context', 'mybooking-reservation-engine' ) );
				$select .= "</option>";
		  }
		  else {
		    ...
		    $select .= "<option value='check-by-email' selected>";
				$select .= wp_kses_post( _x( 'E-mail consultation', 'settings_context', 'mybooking-reservation-engine' ) );
				$select .= "</option>";
		  }
		  else {
		    ...
		    $select .= "<option value='enquiry' selected>";
				$select .= wp_kses_post( _x( 'Enquiry', 'settings_context', 'mybooking-reservation-engine' ) );
				$select .= "</option>";
		  }
		  else {
		  ...
		  echo "<p class=\"description\">";
			...
			echo "</p>";
		  echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'Select <b>Not available</b> to show not available message.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
		  echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'Select <b>Telephone consultation</b> to show Telephone consultation message.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
		  echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'Select <b>E-mail consultation</b> to show E-mail consultation message.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
		  echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'Select <b>Enquiry</b> to show Enquiry message.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
			echo "<hr />";
		}
        ...
        $value = '';
			...
			echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'IMPORTANT: This is basic and experimental functionality', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
			echo "<br />";
      ...
      echo "<p>";
			echo wp_kses_post( _x( '<b>Do not activate</b> if you have create a custom page for each one of your products with the [mybooking_rent_engine_product] or if you are using the [mybooking_rent_engine_selector] or the Selector widget in your home page.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
		  echo "<p>";
			echo wp_kses_post( _x( '<b>Activate</b> it if you are using the [mybooking_rent_engine_products] shortcode to <b>browse the catalog</b> and you want the plugin to automatically create a page for each product.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
		  echo "</div>";
		}
		...
		public function field_mybooking_plugin_settings_products_url_callback() {
		  ...
		  product if <u>Use product detail pages</u> is active.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
		  echo "</div>";
		  echo "<hr />";
		}
    ...
    // == Activities
		...
		public function field_mybooking_plugin_settings_activities_shopping_cart_page_callback() {
		  ...
		  $this->field_mybooking_plugin_activities_settings_page("mybooking_plugin_settings_activities_shopping_cart_page");
			echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'The page with [mybooking_activities_engine_shopping_cart] shortcode.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>.";
		...
		public function field_mybooking_plugin_settings_activities_summary_page_callback() {
		  ...
		  echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'The page with [mybooking_activities_engine_summary] shortcode.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>.";
		...
		public function field_mybooking_plugin_settings_activities_terms_page_callback() {
		  ...
		  $this->field_mybooking_plugin_activities_settings_page("mybooking_plugin_settings_activities_terms_page");
			echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'The page with the terms and conditions.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>.";
		  echo "<hr />";
      ...
      echo "<input type='hidden' name='mybooking_plugin_settings_activities[$field]' value=''/>";
		  ...
		  echo "<div class=\"description\">";
      echo "<p>";
			echo wp_kses_post( _x( 'Do not activate if you have create a custom page for each one of your activities with the [mybooking_activities_engine_activity]', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
		  echo "<p>";
			echo wp_kses_post( _x( 'Activate it if you are using the [mybooking_activities_engine_activities] shortcode to <b>browse the activities catalog</b> and you want the plugin to automatically create a page for each activity.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
		  echo "</div>";
		...
		public function field_mybooking_plugin_settings_activities_url_callback() {
		  ...
		  product if <u>Use detail pages</u> is active.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
		  echo "</div>";
    ...
    // == Transfer
		...
		public function field_mybooking_plugin_settings_transfer_choose_vehicle_page_callback() {
		  ...
		  echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'The page with [mybooking_transfer_choose_vehicle] shortcode.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>.";
		...
		public function field_mybooking_plugin_settings_transfer_checkout_page_callback() {
		  ...
		  $this->field_mybooking_plugin_transfer_settings_page("mybooking_plugin_settings_transfer_checkout_page");
			echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'The page with [mybooking_transfer_checkout] shortcode.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>.";
		...
		public function field_mybooking_plugin_settings_transfer_summary_page_callback() {
		  ...
		  echo "<p class=\"description\">";
			echo wp_kses_post( _x( 'The page with [mybooking_transfer_summary] shortcode.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>.";
    ...
    public function field_mybooking_plugin_settings_complements_popup_callback() {
      ...
      echo "<input type='hidden' name='mybooking_plugin_settings_complements[$field]' value=''/>";
		  ...
		  echo "<p class=\"description\">";
			...
			echo "</p>";
      echo "<p class=\"description\">";
			echo wp_kses_post( _x( '<small>Pop-up will be shown only in the front page.</small>', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
 		}
    ...
    public function field_mybooking_plugin_settings_complements_testimonials_callback() {
      ...
      echo "<input type='hidden' name='mybooking_plugin_settings_complements[$field]' value=''/>";
		  ...
		  echo "<p class=\"description\">";
			...
			echo "</p>";
      echo "<p class=\"description\">";
			echo wp_kses_post( _x( '<small>Create one or more Testimonials under Mybooking menu and use [mybooking_testimonials] to show it on a page or sidebar.</small>', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
 		}
    ...
    public function field_mybooking_plugin_settings_complements_content_slider_callback() {
      ...
      echo "<input type='hidden' name='mybooking_plugin_settings_complements[$field]' value=''/>";
		  ...
		  echo "<p class=\"description\">";
			...
			echo "</p>";
      echo "<p class=\"description\">";
			echo wp_kses_post( _x( '<small>Create one or more Sliders under Mybooking menu and use [mybooking_content_slider] to show it on a page or post.</small>', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
 		}
    ...
    public function field_mybooking_plugin_settings_complements_product_slider_callback() {
      ...
      echo "<input type='hidden' name='mybooking_plugin_settings_complements[$field]' value=''/>";
		  ...
		  echo "<p class=\"description\">";
			...
			echo "</p>";
      echo "<p class=\"description\">";
			echo wp_kses_post( _x( '<small>Create one or more Product Sliders under Mybooking menu and use [mybooking_product_slider] to show it on a page or post.</small>', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
 		}
    ...
    public function field_mybooking_plugin_settings_complements_cookies_callback() {
      ...
      echo "<input type='hidden' name='mybooking_plugin_settings_complements[$field]' value=''/>";
		  ...
		  echo "<p class=\"description\">";
			...
			echo "</p>";
      echo "<p class=\"description\">";
			echo wp_kses_post( _x( '<small>Set the privacy page at WordPress settings to link properly the info button.</small>', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
 		}
    ...
    // == CSS
      ...
      echo "<input type='hidden' name='mybooking_plugin_settings_css[$field]' value=''/>";
		  ...
		  echo "<p class=\"description\">";
			...
			echo "</p>";
		  echo "<p class=\"description\">";
			echo wp_kses_post( _x( '<b>¡Attention!</b> Uncheck if not testimonials or slider are used or if the theme that you are using includes slickJS.', 'settings_context', 'mybooking-reservation-engine' ) );
			echo "</p>";
		}
    ...
    // ------------------------
		...
		private function field_mybooking_plugin_renting_settings_page($field) {
		  ...
		  $select = "<select name='mybooking_plugin_settings_renting[$field]'>";
		  $select .= "<option value=''>[";
			$select .= wp_kses_post( _x( 'Choose page', 'settings_context', 'mybooking-reservation-engine' ) );
			$select .= "]</option>";
