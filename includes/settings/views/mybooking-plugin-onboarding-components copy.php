							...
							<li class="mb-onboarding-component-item">
								...
								<div class="mb-onboarding-component-item-body">
									...
									<div class="mb-onboarding-setup-item-buttons">
										...
										<a role="button" class="button action mb-onboarding-btn-primary" href="/wp-admin/post-new.php?post_type=page" title="<?php echo esc_attr_x( 'Create a new page and paste the shortcode inside', 'onboarding_context', 'mybooking-wp-plugin' ) ?>">
