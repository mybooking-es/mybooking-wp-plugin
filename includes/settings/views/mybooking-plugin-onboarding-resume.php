	...
	<div class="mb-onboarding-title-section">
		<?php if ( $setup_completed ) { ?>
			<h1 class="mb-onboarding-title">
				<?php echo esc_html_x( 'The booking engine has been successfully set up', 'onboarding_context', 'mybooking-reservation-engine' ) ?>
			</h1>
			<p class="mb-onboarding-description">
				<?php echo esc_html_x( 'The reservation process pages are available in the pages option within the Mybooking menu', 'onboarding_context', 'mybooking-reservation-engine' ) ?>
			</p>
		<?php } else { ?>
			<h1 class="mb-onboarding-title mb-onboarding-error">
				<span class="mb-onboarding-icon dashicons dashicons-error"></span>
				<?php echo esc_html_x( 'An error has occurred', 'onboarding_context', 'mybooking-reservation-engine' ) ?>
			</h1>
		<?php } ?>
	</div>
</div>
...
<div class="mb-onboarding-pages mb-onboarding-commons">
	...
	<?php if ( $setup_completed ) { ?>
		<p class="mb-onboarding-pages-notice">
			<?php echo esc_html_x( 'To complete the configuration you can to do the following:', 'onboarding_context', 'mybooking-reservation-engine' ) ?>
		</p>

		<!-- == COMPONENTS SUGGEST == -->
		<h2 class="mb-onboarding-step-title">
			<?php echo esc_html_x( '1. Insert the search engine or selector component on your Home page', 'onboarding_context', 'mybooking-reservation-engine' ) ?>
		</h2>
		<p>
			<?php echo esc_html_x( 'This is the starting point to make a reservation. Copy the shortcode provided and paste it on the place you want to start a booking process, normally that\'s your home page. If you do not have a home page yet you can', 'onboarding_context', 'mybooking-reservation-engine' ) ?>
			<a href="/wp-admin/post-new.php?post_type=page"><?php echo esc_html_x( 'create it now', 'onboarding_context', 'mybooking-reservation-engine' ) ?></a>
		</p>
				...
				<li class="mb-onboarding-component-item">
					...
					<div class="mb-onboarding-component-item-body">
						...
						<div class="mb-onboarding-setup-item-buttons">
							...
							<?php } ?>
							<a role="button" class="mb-onboarding-btn-primary button action" href="/wp-admin/post-new.php?post_type=page" title="<?php echo esc_attr_x( 'Create a new page and paste the shortcode inside', 'onboarding_context', 'mybooking-reservation-engine' ) ?>">
								<?php echo esc_attr_x( 'Create a new page now', 'onboarding_context', 'mybooking-reservation-engine' ) ?>
							</a>
						</div>
				...
				<li class="mb-onboarding-component-item">
					...
					<div class="mb-onboarding-component-item-body">
						...
						<div class="mb-onboarding-setup-item-name">
							...
							<p>
							<strong><?php echo esc_html_x( 'Paste this code where you want to show the catalog:', 'onboarding_context', 'mybooking-reservation-engine' ) ?></strong>
								<code class="mb-onboarding-shortcode">[mybooking_activities_engine_activities]</code>
							</p>
						</div>
						<div class="mb-onboarding-setup-item-buttons">
							<button data-href="[mybooking_activities_engine_activities]" title="<?php echo esc_attr_x( 'Copy shortcode', 'onboarding_context', 'mybooking-reservation-engine' ) ?>" class="mb-onboarding-btn-primary button button-primary mybooking-onboarding-get-shortcode">
								<?php echo esc_attr_x( 'Copy shortcode', 'onboarding_context', 'mybooking-reservation-engine' ) ?>
							</button>
						</div>
					</div>
		...
		<!-- == PAGES LINKS == -->
		<h2 class="mb-onboarding-step-title">
			<?php echo esc_html_x( '2. Complete the setup on your Mybooking account', 'onboarding_context', 'mybooking-reservation-engine' ) ?>
		</h2>
		<p>
			<?php echo wp_kses_post( _x('Mybooking needs to know the URL of <b>summary</b> and <b>my reservation</b> pages in order to link to them when required. Please copy and paste the adresses below, log in into your account and set the paths.', 'onboarding_context', 'mybooking-reservation-engine' ) )?>
		</p>
	...
	<?php } else { ?>
		<p class="mb-onboarding-pages-notice">
			<?php echo esc_html_x( 'We are sorry no page could be created. Please try again and if an error occurs again, contact', 'onboarding_context', 'mybooking-reservation-engine' ) ?>
