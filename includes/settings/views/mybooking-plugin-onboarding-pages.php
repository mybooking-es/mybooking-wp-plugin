		...
		<?php if ( $module_rental ): ?>
			<?php if ( isset($rental_obj['pages_ids']) ) { ?>
				<h2 class="mb-onboarding-step-title">
					<?php echo esc_html_x( 'Reservation process pages for ', 'onboarding_context', 'mybooking-reservation-engine' ) ?>
					<strong>
				...
				<?php } else { ?>
					<?php echo esc_html_x( 'We have not been able to recover any pages', 'onboarding_context', 'mybooking-reservation-engine' ) ?>
				<?php } ?>
			<?php } else { ?>
