  ...
  class MybookingEngineEnqueue {
    ...
    public function enqueue_admin_js() {
      ...
      if ( $screen->id == "toplevel_page_mybooking-plugin-configuration") {
        ...
        $checkout_form_strings = array_merge(
          array(
          ...
          mybooking_checkout_form_section_title_preset_strings()
        );
        wp_localize_script( 'mybooking_wp_admin_checkout_form_builder', 'mybookingCheckoutFormStrings', $checkout_form_strings );
      }
